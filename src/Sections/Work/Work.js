        ...
        const projectImages=projects.map(proj=>{
            return (
                ...
                <Col md={6} sm={12} className="d-flex justify-content-center mt-md-5 mt-2">
                    <Tilt className="Tilt" options={{ max : 30 , scale: 1.1}} style={{ height: 291, width: 300 }}>
                        <Card className="bg-transparent text-white text-center ml-md-0 ml-5">
                            ...
                            <Card.ImgOverlay className="text-left">
                                <Card.Title className='Tilt-inner font-weight-bold' style={{position:"absolute",bottom:40 , left:-45}}>{proj.name}<hr/></Card.Title>
                            </Card.ImgOverlay>
                        </Card>
                    </Tilt>
                </Col>
